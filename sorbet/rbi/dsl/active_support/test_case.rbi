...
class ActiveSupport::TestCase
  sig { params(fixture_name: NilClass, other_fixtures: NilClass).returns(T::Array[Feedback]) }
  sig { params(fixture_name: T.any(String, Symbol), other_fixtures: NilClass).returns(Feedback) }
  sig do
    params(
  ...
  def feedbacks(fixture_name = nil, *other_fixtures); end
